...
(88, '2025_10_10_150552_create_projects_table', 1),
(89, '2025_10_10_150636_create_projects_users_table', 1),
(90, '2025_10_10_150724_create_time_sheets_table', 1),
(91, '2025_10_10_151633_create_personal_access_tokens_table', 1);
...
CREATE TABLE `projects` (
  ...
  `status` enum('active','inactive','completed') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `time_sheets`
  ADD CONSTRAINT `time_sheets_project_id_foreign` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `time_sheets_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
